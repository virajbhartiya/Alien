  ...
  return (
    ...
    >
      ...
      <Callout>
        ...
        <Tooltip
          content={t('Your Device IP should match with Device IP in alert popup appeared on your computer, where Alien is running')}
      ...
      <Text className="bp3-text-muted">
        {t('These details should match with the ones that you see in alert popup on computer screen, where Alien is running')}
      </Text>
    </Card>
  );
}
