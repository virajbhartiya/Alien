  ...
  describe('when MenyBuilder created properly', () => {
    ...
    describe('when menu from buildDarwinTemplate was created', () => {
      ...
      describe('when Help submenu Lean More was clicked', () => {
        it('shoud call shell open external with proper link to https://www.virajbhartiya.github.io/', () => {
          const menu = menuBuilder.buildDarwinTemplate();
          ...
          expect(shell.openExternal).toBeCalledWith(
            'https://www.virajbhartiya.github.io/'
          );
        });
      });

      describe('when Help submenu Documentation was clicked', () => {
        it('shoud call shell open external with proper link to https://github.com/virajbhartiya/alien/blob/master/README.md', () => {
          const menu = menuBuilder.buildDarwinTemplate();
          const submenuView = menu[4];
          const learnMore =
            // @ts-ignore
          ...
          expect(shell.openExternal).toBeCalledWith(
            'https://github.com/virajbhartiya/alien/blob/master/README.md'
          );
        });
      });

      describe('when Help submenu Community Discussions was clicked', () => {
        it('shoud call shell open external with proper link to https://github.com/virajbhartiya/alien/discussions', () => {
          const menu = menuBuilder.buildDarwinTemplate();
          const submenuView = menu[4];
          const learnMore =
            // @ts-ignore
          ...
          expect(shell.openExternal).toBeCalledWith(
            'https://github.com/virajbhartiya/alien/discussions'
          );
        });
      });

      describe('when Help submenu Search Issues was clicked', () => {
        it('shoud call shell open external with proper link to https://github.com/virajbhartiya/alien/issues', () => {
          const menu = menuBuilder.buildDarwinTemplate();
          const submenuView = menu[4];
          const learnMore =
            // @ts-ignore
          ...
          expect(shell.openExternal).toBeCalledWith(
            'https://github.com/virajbhartiya/alien/issues'
          );
        });
      });
    });
