...
export default class MenuBuilder {
  ...
  buildDarwinTemplate(): MenuItemConstructorOptions[] {
    const subMenuAbout: DarwinMenuItemConstructorOptions = {
      ...
      submenu: [
        {
          label: this.i18n.t('About Alien'),
          selector: 'orderFrontStandardAboutPanel:',
        },
        { type: 'separator' },
        {
          label: this.i18n.t('Hide Alien'),
      ...
      submenu: [
        {
          ...
          click() {
            shell.openExternal('https://www.virajbhartiya.github.io/');
          },
        },
        {
        ...
        },
        {
          ...
          click() {
            shell.openExternal('https://github.com/virajbhartiya/alien/issues');
          },
        },
      ],
    };
