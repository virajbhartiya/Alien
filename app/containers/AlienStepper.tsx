...
const AlienStepper = React.forwardRef((_props, ref) => {
  ...
  const handleUserClickedDeviceDisconnectButton = useCallback(async () => {
    ...
    addToast(<Text>{t('Device is successfully disconnected ')}</Text>, {
      appearance: 'info',
      autoDismiss: true,
      ...
      <Dialog isOpen={isNoWiFiError} autoFocus usePortal>
        <Grid>
          <div style={{ padding: '10px' }}>
            ...
            <Row center="xs">
              <H5>Alien works only with WiFi and LAN networks.</H5>
            </Row>
            <Row center="xs">
              <Spinner size={50} />
            </Row>
